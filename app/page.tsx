...
const services = [
  {
    ...
    description:
      "DCS BUSINESS SOLUTIONS can Take your business to the next level with our web design and development services",
  },
  {
    icon: "/images/s_1.png",
    title: "Search Engine Optimization",
    description:
      "DCS will Get your website to the top of search engine results with our SEO services",
  },
  {
    icon: "/images/s_5.png",
  ...
  },
  {
    ...
    description:
      "Interact with your customers and increase sales with our email marketing services of DCS Special Targeting",
  },
  {
    icon: "/images/s_4.png",
      ...
      <main className="md:pb-10">
        <div className="md:px-0 mx-6 xl:w-4/5 2xl:w-[68%] md:mx-auto mt-14">
          ...
          <p className="md:text-center text-xl md:text-2xl my-6 md:my-10 md:w-4/5 mx-auto text-gray-500">
            DCS Design & Marketing Agency - Help Brands Grow with Sharp Designs & Smart Marketing Moves that combine simplicity with bold, impactful results.
          </p>
          ...
          <div className="md:flex items-center justify-between gap-y-4 my-10 gap-x-28 mx-auto">
            <div className="md:w-2/5">
              <h1 className="text-2xl font-medium text-gray-600 w-4/5">
                DCS | Trusted by fast moving brands worldwide
              </h1>
      ...
      <Element name="services">
        <div className="md:px-0 mx-6 xl:w-4/5 2xl:w-[68%] md:mx-auto ">
          ...
          <p className="md:text-center py-4 md:w-1/2 mx-auto text-xl md:text-2xl text-gray-500">
            All of our DCS services are designed to help your business stand out
          </p>
      ...
      <Element name="process">
        <main className="md:px-0 mx-6 md:mx-auto">
          ...
          text-xl md:text-2xl text-gray-500">
            DCS has a 100% Trusted Ratio from our clients All of our services are designed to help your brand to get
            a good bussiness.
          </p>
